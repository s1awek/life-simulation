...
export class UI {
  ...
  init() {
    ...
    // Create Branding Badge
    const branding = document.createElement('div');
    branding.className = 'branding-badge';
    branding.innerHTML = `
      <a href="https://wellmade.online" target="_blank" class="branding-link">
        <span class="branding-text">Created by <span class="highlight">WellMade</span></span>
      </a>
      <div class="branding-separator"></div>
      <a href="https://github.com/s1awek/life-simulation/" target="_blank" class="branding-github" title="View Source">
